 ...
 * 
 * This doesn't work so well, likely as inplace_merge is quite slow. Could try
 * again with more memory and external merge strategy. May also want to merge
 * more than one sorted buffer at a time and control that trade-off better.
 */
#include <algorithm>
#include <future>
#include <chrono>
